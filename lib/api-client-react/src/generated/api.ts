...
export const getSubscribeMutationOptions = <TError = ErrorType<ErrorResult>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SubscribeMutationError = ErrorType<ErrorResult>

    /**
 * @summary Subscribe a lead to Sender.net
 */
export const useSubscribe = <TError = ErrorType<ErrorResult>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof subscribe>>, TError,{data: BodyType<SubscribeInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
